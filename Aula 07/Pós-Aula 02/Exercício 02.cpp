//Exercício incompleto. Favor analizar somente a lógica.

//A meu ver a melhor for de realizar este tipo de execução seria utilizando matriz e listas, mas infelizmente não consegui realizar tal execução.
...
{	
	...
	do
	{
		...
		scanf  ("%d", &F.QTD);
		printf ("Digite o valor unitário: R$");
		scanf  ("%f", &F.Val_Uni);
